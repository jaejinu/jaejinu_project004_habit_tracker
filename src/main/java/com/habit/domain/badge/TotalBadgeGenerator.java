...
@Component
public class TotalBadgeGenerator {

    public String generate(long totalDays, TotalBadgeOptions options) {
        ...
        if (options.label() != null && !options.label().isBlank()) {
            ...
            labelText = ko ? "총 달성" : "total";
        }

        String valueText = ko ? (totalDays + "일") : String.valueOf(totalDays);

        String labelBg = dark ? "#30363d" : "#555";
        String valueBg = "#2f81f7";
